    ...
    >
      <ScrollView style={{ flex: 1 }}>
        ...
        <Text style={styles.LearnText}>
          ...
          with sharps is to raise the last sharp by a half step. A key signature
          with sharps will always follow this order: F#, C#, G#, D#, A#, E#, B#.
          (This can be remembered with Fat Cats Go Down Alleys Eating Bologna).
          {"\n"}
          {"\t"}Therefore, if a key signature has three sharps, it will have the
          first three sharps in the order: F#, C#, and G#. According to the
          strategy, to find the key you must take the last sharp and raise it a
          half step. Since the last sharp in this scenario is G#, you would
          raise it by one note on the piano to get A. To conclude, the major key
          represented by a key signature of three sharps is A Major.
          {"\n"}
          {"\t"}Similarly, if a key signature has five sharps, they will be F#,
          C#, G#, D#, and A#. Since the last sharp is A#, to find the key we
          must raise A# by a half step getting the key of B Major. (If you are
          unsure of how to raise a note a half step, raise the note by one key
          on the piano).
          {"\n"}
        ...
        <Text style={styles.LearnText}>
          {"\t"}The basic logic of identifying the major key of a key signature
          with flats is to identify the second last flat. A key signature with
          flats will always follow the opposite order as sharps: Bb, Eb, Ab, Db,
          Gb, Cb, Fb. (This can be remembered as BEAD Gum Candy Fruit).
          {"\n"}
          ...
          case, they will be Bb, Eb, Ab, Db, and Gb. Since the second last flat
          is Db, the key represented by five flats will be Db Major.
        </Text>
        <Text style={styles.Subtitle}>
        ...
        <Text style={styles.LearnText}>
          ...
          three half steps down will take us to A#, then A, and finally G#. So,
          the relative minor of B Major is G# minor.
          {"\n"}
          {"\t"}Another example is when a key of three flats is Eb Major.
          Traveling down three half steps will go to D, Db, and finally C. This
          means if you are asked to find the minor key of a key signature with
          three flats, you would first recognize the major key of Eb Major and
          then go down to C minor.
        </Text>
        <Text style={styles.Subtitle}>{"\n"}Reversing the Process</Text>
        <Text style={styles.LearnText}>
          {"\t"}Now you know how to identify the key given the key signature but
          what if you are given the key and are asked to find the key signature?
          This process is fairly simple as you just repeat the previous
          strategies but in reverse order. First, you would want to make sure
          the key is in major. This is simple as if it is in minor, you can
          simply go up three half steps to make it major.
          {"\n"}
          ...
          until you get to the key name. Then add an additional flat to make the
          key name the second last flat.
          {"\n"}
